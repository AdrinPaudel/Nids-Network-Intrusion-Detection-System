...
### 2. Run Batch Classification (Quickest Test)

If you have a CSV flow file, you can classify it immediately using the pre-trained model:

```bash
python classification.py --batch path/to/your_flows.csv
```

### 3. Run Live Classification (Requires Java + Npcap)
