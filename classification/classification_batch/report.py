...
class BatchReportGenerator:
    ...
    def __init__(self, mode="batch", model_name="default", batch_filename="unknown",
        ...
        filename_base = os.path.splitext(os.path.basename(batch_filename))[0]
        self.session_folder_name = f"batch_{model_name}{label_suffix}_{filename_base}_{session_ts}"
    ...
    def generate(self, results, classify_stats):
        ...
        with open(summary_path, "w", encoding="utf-8") as f:
            ...
            # Always write Classification Breakdown
            if self.stats["by_class"]:
