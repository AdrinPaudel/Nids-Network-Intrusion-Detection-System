...
echo ""
echo "  3. RUN with elevated privileges (for actual packet capture):"
...
echo "       sudo ./venv/bin/python classification.py --duration 300"
echo ""
echo "     Use 6-class model (if trained):"
echo "       sudo ./venv/bin/python classification.py --model all"
echo ""
...
echo ""
echo "  PERMISSIONS SETUP (Linux/macOS):"
echo ""
echo "     Option A: Use sudo each time (above)"
echo ""
echo "     Option B: Grant Python capabilities (one-time setup, no sudo later):"
